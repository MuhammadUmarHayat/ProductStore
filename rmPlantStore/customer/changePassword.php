...
if (isset($_POST['submit'])) 
{
    ...
    $result = $con->query("SELECT * FROM  `user_table`  where `user_name`='$username' and `password`='$oldpassword' ");
    ...
    {// old password is correct
            ...
            $query = "UPDATE `user_table` SET `password`='$newpassword1' WHERE `user_name`='$username'";
